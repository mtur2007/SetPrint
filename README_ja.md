...
►list                                                                                         :  ►list     ┊         ┊         ┊      ┊   ┊   ┊      ┊      ┊   ┊   ┊      ┊      ┊   ┊   ┊  
  ┣━━ >nadarray                                                                               :    ┣━━ >nadarray     ┊         ┊      ┊   ┊   ┊      ┊      ┊   ┊   ┊      ┊      ┊   ┊   ┊  
  ┃       ┣━━━━ >nadarray ━━━━┳━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━┓                   :    ┃       ┣━━━━ >nadarray ━━━━┳━━━━━━━━━━━━━━━━━━━━━┳━━━━━━━━━━━━━━━━━━━━━┓      ┊   ┊   ┊  
  ┃       ┃               >nadarray ━┳━━━┳━━━┓  >nadarray ━┳━━━┳━━━┓  >nadarray ━┳━━━┳━━━┓    :    ┃       ┃         ┊     >nadarray ━┳━━━┳━━━┓  >nadarray ━┳━━━┳━━━┓  >nadarray ━┳━━━┳━━━┓  
...
►list                                                                                                         :  ►list     ┊         ┊           ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊      
  ┣━━ >nadarray                                                                                               :    ┣━━ >nadarray     ┊           ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊      
  ┃       ┣━━━━ >nadarray [ >nadarray [ 255  0   4  ] >nadarray [ 255 85   0  ] >nadarray [ 255 170  0  ] ]   :    ┃       ┣━━━━ >nadarray [ >nadarray [ 255  0   4  ] >nadarray [ 255 85   0  ] >nadarray [ 255 170  0  ] ] 
  ┃       ┣━━━━ >nadarray [ >nadarray [ 170 255  0  ] >nadarray [ 85  255  0  ] >nadarray [  0  255  4  ] ]   :    ┃       ┣━━━━ >nadarray [ >nadarray [ 170 255  0  ] >nadarray [ 85  255  0  ] >nadarray [  0  255  4  ] ] 
  ┃       ┗━━━━ >nadarray [ >nadarray [  0  170 255 ] >nadarray [  0  85  255 ] >nadarray [  4   0  255 ] ]   :    ┃       ┗━━━━ >nadarray [ >nadarray [  0  170 255 ] >nadarray [  0  85  255 ] >nadarray [  4   0  255 ] ] 
  ┣━━ >nadarray                                                                                               :    ┣━━ >nadarray     ┊           ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊      
  ┃       ┣━━━━ >nadarray [ >nadarray [  4   0  255 ] >nadarray [  0  85  255 ] >nadarray [  0  170 255 ] ]   :    ┃       ┣━━━━ >nadarray [ >nadarray [  4   0  255 ] >nadarray [  0  85  255 ] >nadarray [  0  170 255 ] ] 
  ┃       ┣━━━━ >nadarray [ >nadarray [  0  255 170 ] >nadarray [  0  255 85  ] >nadarray [  4  255  0  ] ]   :    ┃       ┣━━━━ >nadarray [ >nadarray [  0  255 170 ] >nadarray [  0  255 85  ] >nadarray [  4  255  0  ] ] 
  ┃       ┗━━━━ >nadarray [ >nadarray [ 255 170  0  ] >nadarray [ 255 85   0  ] >nadarray [ 255  0   4  ] ]   :    ┃       ┗━━━━ >nadarray [ >nadarray [ 255 170  0  ] >nadarray [ 255 85   0  ] >nadarray [ 255  0   4  ] ] 
  ┣━━ >nadarray                                                                                               :    ┣━━ >nadarray     ┊           ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊      
  ┃       ┣━━━━ >nadarray [    77                        126                       176                    ]   :    ┃       ┣━━━━ >nadarray [    77        ┊   ┊   ┊       126       ┊   ┊   ┊       176       ┊   ┊   ┊    ] 
  ┃       ┣━━━━ >nadarray [    200                       175                       150                    ]   :    ┃       ┣━━━━ >nadarray [    200       ┊   ┊   ┊       175       ┊   ┊   ┊       150       ┊   ┊   ┊    ] 
  ┃       ┗━━━━ >nadarray [    129                       79                        29                     ]   :    ┃       ┗━━━━ >nadarray [    129       ┊   ┊   ┊       79        ┊   ┊   ┊       29        ┊   ┊   ┊    ] 
  ┗━━   None                                                                                                  :    ┗━━   None        ┊           ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊        ┊        ┊   ┊   ┊      
                                                                                                              :  
------------------------------------------------------------------------------------------------------------  :  ------------------------------------------------------------------------------------------------------------
```
...
- ## [] 並行配列 : 配列の`順序`/`次元`の合致
    ...
    配列の`順序`/`次元`の合致 を 軸 の重複にて直線的に表現されるようにしています。
